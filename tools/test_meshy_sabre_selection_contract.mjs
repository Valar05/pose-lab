...
assert(profiles.includes("sourceKey: 'player'"), 'Meshy generated pose clips should source from FPS Arms');
assert(profiles.includes("clipTag: 'FPS-VISUAL-IK-GOLDEN'"), 'Meshy can still generate the pose-only Visual-IK Ready candidate');
assert(profiles.includes("SwordReady: ['0T-Pose -> meshyCharacter [FPS-REST-ARMS roll -120]'"), 'SwordReady should remain on the accepted T-pose/rest baseline');
assert(!profiles.includes("SwordReady: ['OneHandReady -> meshyCharacter [FPS-VISUAL-IK R-120 L-90]'"), 'Visual-IK Ready must not be promoted into SwordReady');
