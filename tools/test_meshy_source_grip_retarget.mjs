...
assert(profiles.includes("targetWeapon: 'WeaponGrip'") && !profiles.includes("targetWeapon: 'WeaponR'"), 'Meshy FPS sword retarget should use restored WeaponGrip conversion, not WeaponR');
