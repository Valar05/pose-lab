...
assert(!profiles.includes("targetWeapon: 'WeaponGrip'") && !profiles.includes("targetWeapon: 'WeaponR'"), 'Meshy FPS sword retarget should not key WeaponGrip or WeaponR; boring FK owns weapon follow');
