...
assert(readyAttachmentOverrideBlock.includes('rotationDeg: [131.704, 12.774, -83.407]'), 'Ready attachment override may rotate only the visible blade basis under the FK socket');
