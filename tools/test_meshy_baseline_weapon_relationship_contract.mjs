...
assert(readyAttachmentOverrideBlock.includes('rotationDeg: [11.704, 12.774, -143.407]'), 'Ready attachment override may rotate only the visible blade basis under the FK socket');
