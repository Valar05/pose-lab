...
function readySense(capture) {
  ...
  return {
    ...
    expectedVisibleRelationship: 'The hand owns the hilt, the hilt is pinned to the authored grip, and the blade projects naturally from the fist.',
    ...
    checks: {
      ...
      hiltHeldAwayFromWrist: checkValue(capture, 'hiltAwayFromRawHand') || checkValue(capture, 'hiltPinnedToSocket'),
      ...
      heldByHandRead: checkValue(capture, 'readyVisualRelationshipAccepted') && checkValue(capture, 'hiltPinnedToSocket') && checkValue(capture, 'realWeaponVisible'),
    },
    supportingMetrics: {
