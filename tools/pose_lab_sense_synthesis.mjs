...
function readySense(capture) {
  ...
  return {
    ...
    checks: {
      ...
      bladeProjectsFromGrip: checkValue(capture, 'readyBladeNotPointingDownThroughBody') && checkValue(capture, 'socketForwardBladeAxisSane') && Number.isFinite(tipRight) && tipRight >= 24 && Number.isFinite(tipDrop) && tipDrop <= 12,
