...
assert(profiles.includes("visibleClipPatterns: ['\\\\[FPS-REST-ARMS', '\\\\[FPS-VISUAL-IK']"), 'Meshy weapon visibility should include accepted T-pose rest and the current Ready review clip');
