...
assert(profiles.includes('handLocalOffset: [0.095, 0.035, -0.01]') && profiles.includes('modelLocalOffset: [1.4, 18, -0.68]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -60.52]'), 'Meshy saber should use the visible hand-local grip placement and mesh-layer manual rotation');
