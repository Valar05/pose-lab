...
assert(profiles.includes('handLocalOffset: [0.095, 0.035, -0.01]') && profiles.includes('modelLocalOffset: [1.01462, 12.80195, -0.47992]') && profiles.includes('rotationDeg: [-163.017, 3.942, -12.978]') && profiles.includes('rotationDeg: [5.666, 87.396, 0]'), 'Meshy saber should use the user-authored shared FK socket position and bone-aligned manual rotation');
