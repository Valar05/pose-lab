...
assert(profiles.includes('handLocalOffset: [0.095, 0.035, -0.01]') && profiles.includes('modelLocalOffset: [1.01462, 12.80195, -0.47992]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -30.52]'), 'Meshy saber should use the visible hand-local grip placement and mesh-layer manual rotation');
