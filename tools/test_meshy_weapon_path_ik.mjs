...
assert(profiles.includes('handLocalOffset: [0.095, 0.035, -0.01]') && profiles.includes('modelLocalOffset: [0, 0, 0]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -90.52]'), 'Meshy saber should use the hand-local palm placement and mesh-layer manual rotation');
