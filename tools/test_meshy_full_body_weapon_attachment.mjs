...
assert(profiles.includes('scale: 0.47493') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -90.52]'), 'Meshy weapon attachment should preserve the accepted T-pose FK rotation on the mesh layer with identity WeaponGrip');
