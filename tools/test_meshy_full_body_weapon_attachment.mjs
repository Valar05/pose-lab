...
assert(profiles.includes('scale: 0.47493') && profiles.includes('rotationDeg: [90, 75.87377, -75.87377]'), 'Meshy weapon attachment should solve saber handle-to-tip onto WeaponGrip +Z');
assert(profiles.includes('gripLocalPosition: [0.78, -0.3, 0]') && profiles.includes('tipLocalPosition: [-0.95561, 0.1368, 0]'), 'Meshy weapon attachment should grip the saber handle and track the real blade tip');
