...
assert(profiles.includes('scale: 0.47493') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [90, 0, -55.145]'), 'Meshy weapon attachment should preserve the accepted T-pose FK rotation on the mesh layer with identity WeaponGrip');
...
assert(profiles.includes('modelLocalOffset: [-0.11512, 0.00773, -0.01127]'), 'Meshy weapon socket should carry the accepted T-pose hand-local grip displacement after boring FK placement');
