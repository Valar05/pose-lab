...
assert(data.attachmentSnapshots?.meshy?.attachment?.gripLocalPosition?.join(',') === '0.73272,0.0091,-0.01674', 'Meshy snapshot should preserve the visible hilt candidate');
