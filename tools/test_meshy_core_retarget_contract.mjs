...
assert(profiles.includes('modelLocalOffset: [-0.11512, 0.00773, -0.01127]') && profiles.includes('gripLocalPosition: [0.73272, 0.0091, -0.01674]'), 'Meshy visible hilt placement must remain locked as repository truth');
