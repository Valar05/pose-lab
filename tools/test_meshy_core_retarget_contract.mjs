...
assert(profiles.includes('modelLocalOffset: [1.01462, 12.80195, -0.47992]') && profiles.includes('gripLocalPosition: [0.6535, -0.02302, -0.07317]') && profiles.includes('rotationDeg: [-163.017, 3.942, -12.978]') && profiles.includes('rotationDeg: [5.666, 87.396, 0]'), 'Meshy visible hilt placement and blade-aligned rotation must remain locked to the user-authored shared FK calibration');
