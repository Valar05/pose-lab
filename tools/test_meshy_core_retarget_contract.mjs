...
assert(profiles.includes('modelLocalOffset: [-0.11512, 0.00773, -0.01127]') && profiles.includes('gripLocalPosition: [0.69507, -0.02421, -0.06231]'), 'Meshy user hilt oracle placement must remain locked as repository truth');
