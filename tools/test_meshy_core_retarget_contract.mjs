...
assert(profiles.includes('modelLocalOffset: [1.15887, 14.47175, -0.54361]') && profiles.includes('gripLocalPosition: [0.6535, -0.02302, -0.07317]'), 'Meshy visible hilt placement must remain locked to the user-authored shared FK calibration');
