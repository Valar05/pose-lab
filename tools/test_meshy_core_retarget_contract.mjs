...
assert(profiles.includes('modelLocalOffset: [0.35, 4.5, -0.17]') && profiles.includes('gripLocalPosition: [0.73272, 0.0091, -0.01674]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -90.52]'), 'Meshy visible hilt placement and mesh-layer rotation must remain locked to the user-authored shared FK calibration');
