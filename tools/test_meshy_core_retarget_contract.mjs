...
assert(profiles.includes('modelLocalOffset: [0, 0, 0]') && profiles.includes('gripLocalPosition: [0.6535, -0.02302, -0.07317]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -90.52]'), 'Meshy visible hilt placement and mesh-layer rotation must remain locked to the user-authored shared FK calibration');
