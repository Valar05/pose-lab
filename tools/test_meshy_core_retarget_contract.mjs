...
assert(profiles.includes('modelLocalOffset: [1.01462, 12.80195, -0.47992]') && profiles.includes('gripLocalPosition: [0.6535, -0.02302, -0.07317]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -30.52]'), 'Meshy visible hilt placement and mesh-layer rotation must remain locked to the T-pose-authored FK calibration');
