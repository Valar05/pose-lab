...
assert(profiles.includes('modelLocalOffset: [-3.6, 18, -0.68]') && profiles.includes('gripLocalPosition: [0.73272, 0.0091, -0.01674]') && profiles.includes('rotationDeg: [0, 0, 0]') && profiles.includes('rotationDeg: [-67.582, 76.718, -30.52]'), 'Meshy visible hilt placement and mesh-layer rotation must remain locked to the user-authored shared FK calibration');
