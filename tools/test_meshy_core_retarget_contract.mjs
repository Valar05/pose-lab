...
assert(profiles.includes('modelLocalOffset: [1.01462, 12.80195, -0.47992]') && profiles.includes('gripLocalPosition: [0.6535, -0.02302, -0.07317]'), 'Meshy visible hilt placement must remain locked to the user-authored shared FK calibration');
