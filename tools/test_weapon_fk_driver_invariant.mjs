...
assert(attachmentOverrideBlock.includes('rotationDeg: [44.1, -105, -129.2]'), 'Ready may use a rotation-only attachment override to correct the visible blade basis under the FK socket');
