...
assert(attachmentOverrideBlock.includes('rotationDeg: [11.704, 12.774, -143.407]'), 'Ready may use a rotation-only attachment override to correct the visible blade basis under the FK socket');
