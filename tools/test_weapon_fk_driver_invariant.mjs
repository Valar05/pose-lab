...
assert(attachmentOverrideBlock.includes('rotationDeg: [26.5, -114, -75]'), 'Ready may use a rotation-only attachment override to correct the visible blade basis under the FK socket');
