...
export function deriveAttachmentBladeLocal(THREE, attachment = {}) {
  ...
  const rotationDeg = Array.isArray(attachment.rotationDeg) ? attachment.rotationDeg : [85, -140, -60];
...
// Pose-only salvage path: normal Meshy Ready generation must not emit WeaponR or WeaponGrip tracks.
// The optional weapon branch below remains inert unless an explicit experimentalWeaponSwing config is passed.
